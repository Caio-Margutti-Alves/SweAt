package usp.each.si.ach2006.codesport.camera;
...
public class CameraActivity extends Activity {
	...
	//private static Button btnVideo;
	...
	public CameraActivity(ImageView imgv){
		super();
		CameraActivity.mImageView = imgv;
		//CameraActivity.mVideoView = vidv;
		//CameraActivity.btnPicture = btnPicture;
		//CameraActivity.btnVideo = btnVideo;
